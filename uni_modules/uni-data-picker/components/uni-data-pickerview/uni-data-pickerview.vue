	...
	<view class="uni-data-pickerview">
		...
		<view class="tab-c">
			<scroll-view class="list" :scroll-y="true">
				<view class="item" v-for="(item, j) in dataList[selectedIndex]" :key="j"
					:class="{'is-disabled': !!item.disable,'item-check':selected.length > selectedIndex && item[map.value] == selected[selectedIndex].value}"
...
<style lang="scss">
	...
	.item-check {
		background: rgba(247, 188, 5, 0.15);
	}
