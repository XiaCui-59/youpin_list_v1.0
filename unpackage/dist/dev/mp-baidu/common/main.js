...
var customModal = function customModal() {
  __webpack_require__.e(/*! require.ensure | components/custom_modal */ "components/custom_modal").then((function () {
    return resolve(__webpack_require__(/*! @/components/custom_modal.vue */ 172));
  }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
};
var aiChat = function aiChat() {
  Promise.all(/*! require.ensure | components/ai_chat */[__webpack_require__.e("common/vendor"), __webpack_require__.e("components/ai_chat")]).then((function () {
    return resolve(__webpack_require__(/*! @/components/ai_chat.vue */ 179));
  }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
};
var login = function login() {
  __webpack_require__.e(/*! require.ensure | components/login */ "components/login").then((function () {
    return resolve(__webpack_require__(/*! @/components/login.vue */ 187));
  }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
};
_vue.default.component("customModal", customModal);
_vue.default.component("aiChat", aiChat);
...
_vue.default.prototype.getUsrInfo = function () {
  var _this = this;
  return new Promise(function (resolve) {
    _this.$request("/worker/profile").then(function (res) {
      if (res.code == 0) {
...
_vue.default.prototype.queryPubStatus = function () {
  ...
  return new Promise(function (resolve) {
    ...
    if (token) {
      ...
      _this2.$request("/worker/wechat/official-account/is-subscribe").then(function (res) {
        if (res.code == 0) {
...
createApp(app).$mount();
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-baidu/dist/index.js */ 1)["default"], __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-baidu/dist/index.js */ 1)["default"], __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-baidu/dist/index.js */ 1)["createApp"]))
